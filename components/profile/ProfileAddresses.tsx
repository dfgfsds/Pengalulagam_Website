  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Button className="bg-[#a8822d] hover:bg-[#977526]"
          ...
          <Card key={address.id} className="relative">
            {address?.selected_address && (
              <div className="absolute top-2 right-2">
                <span className="bg-[#a8822d]/10 text-[#a8822d] text-xs font-medium px-2.5 py-0.5 rounded">
                  Default
                </span>
              </div>
            )}
          ...
          >
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              <button
                ...
                disabled={loading}
                className="cursor-pointer px-4 py-2 bg-[#a8822d] text-white rounded-md text-sm font-medium hover:bg-[#977526] gap-2 flex"
              >
