  ...
  return (
    <div className="space-y-8">
      <Card>
        ...
        <CardFooter>
          <Button onClick={handleUpdate} className="ml-auto bg-[#a8822d] hover:bg-[#977526]">
            Save Changes
          </Button>
        </CardFooter>
      </Card>
      ...
      {/* <Card>
        ...
        <CardFooter>
          <Button className="ml-auto bg-[#a8822d] hover:bg-[#977526]">
            Update Password
          </Button>
        </CardFooter>
      </Card> */}
      ...
      <div className="flex justify-between items-center pt-2">
        <Button 
        className='bg-[#a8822d] hover:bg-[#977526] text-white'
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                ...
                className="cursor-pointer px-4 py-2 bg-[#a8822d] text-white rounded-md text-sm font-medium hover:bg-[#977526]"
              >
                Confirm Logout
              </button>
            </div>
