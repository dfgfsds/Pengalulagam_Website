  ...
  return (
    <Tabs defaultValue="description" className="mb-16">
      <TabsList className="w-full sm:w-auto grid grid-cols-3 sm:inline-flex h-auto p-0 bg-transparent gap-2">
        <TabsTrigger 
          value="description" 
          className="data-[state=active]:border-b-2 data-[state=active]:border-[#a8822d] data-[state=active]:text-[#a8822d] rounded-none"
        >
          Description
        </TabsTrigger>
        <TabsTrigger 
              ...
              <div key={index} className="border-b border-border pb-6 last:border-0">
                <div className="flex justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-full bg-[#a8822d]/10 flex items-center justify-center text-[#a8822d] font-medium">
                      {['JD', 'SM', 'AR'][index]}
                    </div>
                    <div>
