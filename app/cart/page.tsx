    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-12">
        ...
        {matchingProductsArray?.length === 0 ? (
          ...
          //   <Link href="/products" className="mt-4 text-[#a8822d] hover:underline flex">
          //     Start Shopping 
          ...
          <div className="flex flex-col items-center justify-center h-max text-gray-800 animate-fadeIn">
            <div className="text-6xl text-gray-400 animate-float">
              <ShoppingBag className="h-16 w-16 text-[#a8822d] mb-4" />
            </div>
            ...
            <button onClick={()=>router.push('/products')}
              className="mt-8 px-6 py-3 bg-[#a8822d] text-white rounded-full shadow-md hover:bg-green-700 transform transition hover:scale-105 animate-bounce"
            >
              Return To Shop
            </button>
          </div>
              ...
              <div className="bg-[#F8F7F2] rounded-xl overflow-hidden">
                <div className="p-6">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <Link href="/products" className="text-[#a8822d] hover:underline text-sm flex items-center">
                      Continue Shopping
