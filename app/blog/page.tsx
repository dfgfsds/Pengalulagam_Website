        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 flex items-center">
          <div>
            ...
            <p className="text-xl text-white/90">
              Be a part of our journey toward promoting healthy, organic, and sustainable hygiene solutions for women. Together, we can make every period safe and stress-free.
            </p>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-sm font-medium text-[#a8822d]">
                    {post?.title}
                ...
                <h2 className="text-xl font-semibold mb-2 group-hover:text-[#a8822d] transition-colors">
                  {post?.subtitle}
