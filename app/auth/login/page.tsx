...
import { Mail, Lock, Eye, EyeOff, Loader, Smartphone, KeyRound, User } from 'lucide-react';
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex gap-2 justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#a8822d] hover:bg-green-700"
            >
              {loginType === 'EMAIL'
                ? 'Login'
                : step === 'LOGIN'
            ...
            <p className="text-sm text-center text-gray-500">
              ...
              <Link href="/auth/register" className="text-[#a8822d] hover:text-green-600 font-medium">Register</Link>
            </p>
          </form>
        </div>
      </div>
