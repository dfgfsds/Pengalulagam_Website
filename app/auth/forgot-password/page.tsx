    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 p-2">
      ...
      {!showPasswordReset && (
        <form onSubmit={handleEmailSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full gap-2 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#a8822d] hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            disabled={emailLoader}
          >
          ...
          <div className="bg-white w-full max-w-md p-6 rounded shadow-lg relative">
            ...
            <div className="flex justify-between">
              <button
                ...
                className="w-full cursor-pointer  bg-[#a8822d] text-white py-2 rounded hover:bg-green-700"
                disabled={optLoader}
              >
